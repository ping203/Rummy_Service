 ...
 * @author UserXP
 */
public class ThaiLoginHandler implements LoginHandler {
...
//	}
    ...
    public LoginResponseAction handle(LoginRequestAction action) {
    	...
    	try {
    		//Thread.sleep(5000);
    		loggerLogin_.info("==>StartLogin Thai:" + (new Date()).toString() +": "+ action.getUser() + "---" + action.getOperatorid() + "-" + action.getPassword());        	
