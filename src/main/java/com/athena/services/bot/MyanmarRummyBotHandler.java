...
public class MyanmarRummyBotHandler implements Bot {
    ...
    public MyanmarRummyBotHandler(int source) {
        getListBot(source);
    }
...
//                System.out.println("Size listBotRummy: " + listBotRummy.size());
                ...
                for (int i = 0; i < listBotRummy.size(); i++) {
                    ...
                    System.out.println("====>stt: " + i+" - " + "gameId: " + listBotRummy.get(i).getGameid() + " - Type: " + listBotRummy.get(i).getUsertype());
                    if (listBotRummy.get(i).getGameid() == gameId // client bot connected
                        ...
                        if (addAG > 0) {
                            ...
                            u.setAG((long) addAG);
                            ActionUtils.updateAGBOT(u, u.getAG().intValue(), abDB, GAMEID.MYANMAR_RUMMY);
                        }
    ...
    public void getListBot(int source) {
        ...
        try {
            ...
            cs.setInt("Gameid", GAMEID.MYANMAR_RUMMY);
            ...
            while (rs.next()) {
                ...
                } else if (type <= bot100 && type > bot10) {
                ...
                ActionUtils.updateAGBOT(userTemp, ag, agDB, GAMEID.MYANMAR_RUMMY);
                ...
                if (listBotRummy.get(i).getGameid() == gameid && listBotRummy.get(i).getUsertype() == type
                    ...
                    if (u.getAG() < 80 * mark && u.getCPromot() < MAX_ADD_AG) { // kiem tra them tien cho bot
                        ...
                        if (addAG > 0) {
                            ...
                            ActionUtils.BotLogIFRS(u.getUserid(), u.getAG().intValue(), addAG, GAMEID.MYANMAR_RUMMY);
                        }
