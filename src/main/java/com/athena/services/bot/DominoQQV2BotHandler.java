...
public class DominoQQV2BotHandler implements Bot{
    public final static Integer GAMEID = com.athena.services.utils.GAMEID.DOMINOQQ;
    ...
    public DominoQQV2BotHandler(int source) {
        getListBot(source);
    }
